...
describe('accuracyCalculator', () => {
  describe('calculateAccuracy', () => {
    ...
    it('handles edge case of zero total characters', () => {
  ...
  describe('getAccuracyDetails', () => {
    ...
    it('handles empty strings and character comparisons', () => {
