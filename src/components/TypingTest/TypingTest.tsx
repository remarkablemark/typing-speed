...
export function TypingTest({
  ...
  return (
    <div className="p-4">
      ...
      {/* Stats Display */}
      <div className="mx-auto mb-4 grid w-full grid-cols-2 gap-3 sm:grid-cols-4 sm:gap-4">
      ...
      <div className="mt-4 h-[40px]">
        {!isActuallyComplete && userInput.length > 0 && (
          <div className="rounded bg-blue-50 p-3 text-blue-800 dark:bg-blue-900/20 dark:text-blue-300">
